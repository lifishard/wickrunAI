    ...
    return (
      <div>
        <div className="section">
          ...
          {tools.reviewCodeChanges === true ? <p className="hint">{t('本机客户端里只有 Grok 能在开启后进入工作模式：它的每处修改先展示差异，批准后才写入，命令不运行。Claude Code、Codex、Kimi 和 Claude Desktop 会先弹窗说明，这一轮不进入工作模式。')}</p> : null}
        </div>
        <div className="section">
