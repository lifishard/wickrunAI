...
import FailoverList, { type RouteOption, type FailoverScopes } from './FailoverList';
  ...
  return (
    <div>
      ...
      {props.onFailoverChange ? <FailoverList
        scopes={props.failoverScopes ?? {}}
        projectName={props.failoverProjectName}
